...
void Op::accept(Visitor* current) {
	current->opNode(this);
}
...
void Add::accept(Visitor* current) {
	current->addNode();
}
...
void Sub::accept(Visitor *current) {
	current->subNode();
}
...
void Mult::accept(Visitor *current) {
	current->multNode();
}
...
void Sqr::accept(Visitor* current) {
	current->sqrNode();
}
...
void Root::accept(Visitor* current) {
	current->rootNode();
}
